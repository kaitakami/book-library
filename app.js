...
nameInput.addEventListener('invalid', () => {
  if (nameInput.value === '') {
    nameInput.setCustomValidity('Write the book name');
  } else {
    nameInput.setCustomValidity('Book titles can only contain upper and lowercase letters. Try again!');
  }
});
...
pagesInput.addEventListener('invalid', () => {
  if (nameInput.value === '') {
    nameInput.setCustomValidity('Insert the pages number');
  } else {
    nameInput.setCustomValidity('Insert a number bigger than one');
  }
});
